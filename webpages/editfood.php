...
<body>
  ...
  <?php if($_SESSION["role"] === 'admin') { ?>
   ...
   <section id="hero">
   <h2>Add Food</h2>
    <form id="addFoodForm" action="includes/editFoodInc.php" method="POST" enctype="multipart/form-data">
        <label for="findName">Food to edit:</label>
        <input type="text" name="findName"><br>
